...
function GameCard({ name }: { name: string }) {
  return (
    <div className="relative w-full max-w-xs p-3 py-4 text-black transition-all duration-300 bg-white rounded-md cursor-pointer hover:shadow-2xl hover:stroke-">
      ...
      <div className="">
        <div className="mt-2 text-2xl font-blogh text-main-1">{name}</div>
